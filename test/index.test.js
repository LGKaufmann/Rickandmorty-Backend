...
describe("Test de RUTAS", () => {
  describe("GET /rickandmorty/character/:id", () => {
    ...
    it("Si hay un error responde con status: 404", async () => {
      await agent.get("/rickandmorty/character/3123231").expect(404);
    });
  });
  ...
  describe("GET /rickandmorty/login", () => {
    it("La informacion del login es correcta", async () => {
      const response = (
        await agent.get(
          `/rickandmorty/login?email=admin@admin.com&password=lauty123`
        )
      ).body;
    ...
    it("La informacion del login es incorrecta", async () => {
      const response = (
        await agent.get(
          `/rickandmorty/login?email=lautykaufmann@gmail.com&password=lauty13`
        )
      ).body;
  ...
  describe("POST /rickandmorty/fav/:id", () => {
    const character1 = { id: "1", name: "ivan" };
    const character2 = { id: "2", name: "jose" };
  ...
  describe("DELETE /rickandmorty/fav/:id", () => {
    const character1 = { id: "1", name: "ivan" };
    const character2 = { id: "2", name: "jose" };
    it("Devuelvo arreglo con los elementos previos", async () => {
